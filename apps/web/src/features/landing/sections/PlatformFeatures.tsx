...
const STEPS = [
  ...
  },
  {
    ...
    d: "Growing market share and brand positioning through: 1. Channel performance 2. Channel development 3. Operational flow management",
  },
];
      ...
      <div className="mx-auto max-w-[1160px]">
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
          {STEPS.map((s) => (
            <div
              key={s.n}
              className="flex gap-5 rounded-3xl border border-brand-line bg-white p-7 shadow-sm transition hover:-translate-y-0.5 hover:shadow-md"
            >
